...
23.Jun.2017
Initplayerlocal.sqf
//--- DAS SCRIPT SOLL WARTEN BIS DER CLIENT DIE SPIELFIGUR UEBERNOMMEN HAT
...
#define DOF_DRAGTEXT									"<t color='#FF0000'>Drag Body</t>"				// AddAction text for drag
#define DOF_DROPTEXT									"<t color='#8c0000'>Drop Body</t>"				// AddAction text for drag	
