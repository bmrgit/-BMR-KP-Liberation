...
Files needed:
\scripts\bmr\GOM\dialogs\GOM_dialog_controls.hpp
\scripts\bmr\GOM\dialogs\GOM_dialog_parents.hpp
\scripts\bmr\GOM\functions\GOM_fnc_aircraftLoadoutInit.sqf
\scripts\bmr\GOM\functions\GOM_fnc_aircraftLoadoutParameters.sqf //adjust parameters here
\scripts\bmr\GOM\functions\GOM_fnc_functions.hpp
\description.ext
