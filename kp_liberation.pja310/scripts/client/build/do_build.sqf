		...
		if ( buildtype == 8 ) then {
			...
			if ( build_confirmed == 2 ) then {
				...
				switch (_classname) do {
					case "Land_Missle_Trolley_02_F": { _vehicle spawn GOM_fnc_addAircraftLoadoutToObject; };
					case "B_Slingload_01_Repair_F": { [_vehicle,10000] spawn GOM_fnc_setRepairCargo; };
					case "B_Slingload_01_Fuel_F": { [_vehicle,10000] spawn GOM_fnc_setFuelCargo; };
